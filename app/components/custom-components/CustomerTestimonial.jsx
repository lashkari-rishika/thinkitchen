...
const CustomerTestimonial = () => {
  ...
  return (
    <div className="testimonial-section mt-10 mb-14 sm-only:px-3 px-10">
      ...
      <div key={item.id} className="bg-white mt-2 lg:w-5/6 sm:w-full mx-auto">
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-center md:justify-between relative">
            <div className="md:w-1/2 md:mr-4 mb-4 md:mb-0">
              <img src={item.imageSrc} alt="Testimonial" className="shadow-lg" />
            </div>
            <div className="md:w-1/2 md:ml-4">
              <div className="text-center md:text-left">
                ...
                <div className="items-center justify-center md:justify-start absolute right-8 bottom-8">
                  ...
                  <span>
                    <img src={item.starimg} alt="5 Star Rated" className="h-6 mr-2" />
                  </span>
                </div>
              </div>
            </div>
