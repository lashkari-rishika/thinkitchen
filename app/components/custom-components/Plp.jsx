...
const Plp = () => {
  ...
  const handleOptionSelect = (option) => {
    console.log(
      '🚀 ~ file: Plp.jsx:246 ~ handleOptionSelect ~ option:',
      option,
    );
                  ...
                  <Link href={product.link} className="w-full" target="_blank">
                    ...
                    <div className="px-1 py-2 flex w-full md-max:flow-root">
                      ...
                      <div className=" product_card_button 4/12 md-max:w-[50%]">
                        <button className="add_cart_button text-sm md-omly:text-[0.675rem] md-only:text-[0.65rem] md-only:leading-[1rem] block w-full bg-white-500 font-semibold text-white py-[5px] px-2 md-only:px-1 border border-solid bg-[#175C8A] border-gray-300 min-w-max relative ">
                          {/* <Text
                      as="span"
                    ...
                    > */}
                          <span className="logo1 absolute inset-y-0 left-0 flex items-center pl-2">
                            <img
                              src="https://cdn.shopify.com/s/files/1/0293/6448/6192/files/cart_r.png?v=1693289705"
                              alt=""
                            />
                          </span>
                          <span className="text1">Add to Cart</span>
                        </button>
                      </div>
                    </div>
                  </Link>
