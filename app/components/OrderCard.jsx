...
export function OrderCard({ order }) {
  ...
  return (
    <li className="grid text-center border rounded">
      ...
      <div className="ml-auto my-auto"> {/* Align button to the right and center vertically */}
        <Link
          className="bg-sky-600 text-white px-6 py-2 lg:text-sm"
          to={`/account/orders/${legacyOrderId}?${key}`}
          prefetch="intent"
        >
          <Text color="subtle" className="">
            Order Detail
          </Text>
        </Link>
      </div>
