            ...
            <div className="w-11/12  mx-auto mb-14 sm:w-6/12  lg:w-10/12 ">
                <div className="container">
                    ...
                    <div className="bg-stone-100 flex py-3.5 flex-wrap">
                        <div className="w-40 pl-2  md:w-44  lg:w-80 pl-4">
                        ...
                        <div className="w-80 border-l border-zinc-300 border-inherit pl-4 w-20">
                            <div className="bg-white w-10 h-10 mb-1.5 rounded-full flex items-center justify-center">
                        ...
                        <div className="w-20 w-80 border-l border-zinc-300 border-inherit pl-4">
                            <div className="bg-white w-10 h-10 mb-1.5 rounded-full flex items-center justify-center">
                        ...
                        <div className="w-72 border-l  border-zinc-300 pl-4 w-24">
                            <div className="bg-white w-10 h-10 mb-1.5 rounded-full flex items-center justify-center">
