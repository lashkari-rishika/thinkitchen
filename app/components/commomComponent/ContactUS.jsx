...
const Contactsection = () => {
    return (
        <section>
            ...
            <div className="w-10/12 mx-auto mb-14 sm-only:w-11/12">
                <div className="container mx-auto">
                    <div className="flex flex-wrap py-3.5 bg-stone-100  sm-only:flex gap-2">
                        <div className="w-72 pl-4 sm-only:w-40">
                            ...
                            <div className="sm-only:flex items-center">
                                ...
                                <div className="">
                                    <h1 className="ml-2.5 text-black text-base font-bold top-0.5  lg-only:text-lg">Address</h1>
                                </div>
                            </div>
                        ...
                        <div className=" w-72 border-l border-zinc-300 border-inherit pl-4 sm-only:w-40">
                            <div className="sm-only:flex items-center">
                                ...
                                <div>
                                    <h1 className="sm:only:text-[15px] text-black font-bold lg:text-lg">For Enquiries:</h1>
                                </div>
                            </div>
            ...
            <div className="mx-auto w-10/12 sm-only:w-11/12">
                <div className="container mx-auto">
                    <form>
